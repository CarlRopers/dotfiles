...
alias lslinks='ls --color=always -lhaF | \grep --color=never ^l'
alias lsdirs='ls --color=always -lhaF | \grep --color=never ^d'
alias lsfiles='ls --color=always -lhaF | \grep --color=never ^-'
